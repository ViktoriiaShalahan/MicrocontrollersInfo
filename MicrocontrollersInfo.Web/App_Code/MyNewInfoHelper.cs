...
namespace MicrocontrollersInfo.Web.App_Code
{
    public static class MyNewInfoHelper
    {
        public static MvcHtmlString InformationHeader(this HtmlHelper html, string header)
        {
